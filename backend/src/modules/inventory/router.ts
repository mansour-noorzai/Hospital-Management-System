...
router.get('/categories', authenticate, authorize('inventory', 'read'), InventoryController.listCategories);
router.post('/categories', authenticate, authorize('inventory', 'write'), InventoryController.createCategory);
router.delete('/categories/:id', authenticate, authorize('inventory', 'write'), InventoryController.deleteCategory);
