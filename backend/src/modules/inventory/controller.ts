...
export async function listCategories(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    res.json(successResponse(await InventoryService.listCategories()));
  } catch (err) { next(err); }
}
...
export async function createCategory(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    res.status(201).json(successResponse(await InventoryService.createCategory(parsed.data)));
  } catch (err) { next(err); }
}
...
export async function deleteCategory(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    if (!req.user) return next(new AuthError());
    res.json(successResponse(await InventoryService.deleteCategory(req.params.id)));
  } catch (err) { next(err); }
}
