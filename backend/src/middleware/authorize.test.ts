...
describe("authorize middleware", () => {
  ...
  // -------------------------------------------------------------------------
  describe("admin role", () => {
    const adminUser: AuthUser = { _id: "admin-id", role: "admin", hospitalId: "hospital-id", isPlatformAdmin: false };
  ...
  describe("doctor role", () => {
    const doctor: AuthUser = { _id: "doc-id", role: "doctor", hospitalId: "hospital-id", isPlatformAdmin: false };
  ...
  // -------------------------------------------------------------------------
  describe("nurse role", () => {
    const nurse: AuthUser = { _id: "nurse-id", role: "nurse", hospitalId: "hospital-id", isPlatformAdmin: false };
  ...
  describe("receptionist role", () => {
    const receptionist: AuthUser = { _id: "rec-id", role: "receptionist", hospitalId: "hospital-id", isPlatformAdmin: false };
  ...
  describe("patient role — own-only", () => {
    const patient: AuthUser = { _id: "patient-id", role: "patient", hospitalId: "hospital-id", isPlatformAdmin: false };
