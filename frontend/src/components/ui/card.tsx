...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('rounded-[22px] border border-border/70 bg-card text-card-foreground shadow-[var(--card-shadow)]', className)} {...props} />
  )
);
...
const CardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('min-w-0 break-words p-5 sm:p-6', className)} {...props} />
  )
);
